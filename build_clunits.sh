...
(load "festvox/bamu_mar_sangram_clunits.scm")
...
(set! bamu_mar_sangram::dt_params
      (cons
       ;; in case bamu_mar_sangram_clunits defines this too, put this at start
       (list 'db_dir (string-append bamu_mar_sangram::dir "/"))
       (append
	bamu_mar_sangram::dt_params
	(list
	;;; In bamu_mar_sangram_clunits.scm
	 ;;'(coeffs_dir "lpc/")
	 ;;'(coeffs_ext ".lpc")
	 ...
	 ;; Join weights in bamu_mar_sangram_clunits.scm
...
;	 (trees_dir "festival/trees/")  ;; in bamu_mar_sangram_clunits.scm
         (list
          'wagon_field_desc 
...
;	 (catalogue_dir "festival/clunits/")  ;; in bamu_mar_sangram_clunits.scm
	 ;;  Run time parameters 
	 ;; all in bamu_mar_sangram_clunits.scm
...
Get setup ready for (do_all) (or (do_init))."
  (eval (list bamu_mar_sangram::closest_voice))
...
labels for prompts and aligning."
  (set! bamu_mar_sangram::clunits_prompting_stage t)
